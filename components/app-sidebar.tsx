...
const units = [
  ...
  },
  {
    ...
    topics: [
      { title: "N-Queens", path: "/units/backtracking-branch-bound/n-queens" },
      { title: "Subset-sum", path: "/units/backtracking-branch-bound/subset-sum" },
      { title: "Hamiltonian Circuit", path: "/units/backtracking-branch-bound/hamiltonian-circuit" },
      { title: "Knapsack (Branch-and-Bound)", path: "/units/backtracking-branch-bound/knapsack-bb" },
      { title: "Travelling Salesman", path: "/units/backtracking-branch-bound/tsp" },
      { title: "DFS & BFS", path: "/units/backtracking-branch-bound/dfs-bfs" },
      { title: "Floyd–Warshall", path: "/units/backtracking-branch-bound/floyd-warshall" },
    ],
  },
  {
    title: "Random & Approx.",
